...
//alert(names[0]);
  ...
  if (d.id==-99){
    ...
    if(currElement[0]){
      d.name = currElement[0].name + ": Birthrate is: " + currElement[0].birthrate;
      d.birthrate = currElement[0].birthrate;
      console.log(n.id + " ");
    }
    //console.log(d);
	}
...
var colorIncrement = 200;
  ...
  country
   .enter()
    .insert("path")
    .attr("class", function(d,i){return "country" + d.birthrate;})    
      .attr("title", function(d,i) { return d.name; })
      .attr("d", path)
      .style("fill", function(d, i) {
        //var colorInt = 8517892;
        var countryColor = colorInt + (colorIncrement * d.birthrate);
